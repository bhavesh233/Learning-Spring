...
public class StudentRestExecptionHandler {
    ...
    @ExceptionHandler
    public ResponseEntity<StudentErrorResponseData> handleException(Exception exc){
        ...
        return  new ResponseEntity<StudentErrorResponseData>(error,HttpStatus.BAD_REQUEST);
